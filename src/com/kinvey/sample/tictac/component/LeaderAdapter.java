...
public class LeaderAdapter extends ArrayAdapter<GameEntity> {
	...
	public LeaderAdapter(Context context, List<GameEntity> objects, LayoutInflater inf) {
	 ...
	 * screen, and then they are recycled. This allows us to avoid creating a
	 * new view for every single row, which can have a negative effect on
